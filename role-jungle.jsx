  ...
  meta: {
    ...
    sigil: (
      <svg viewBox="0 0 200 200" fill="none" stroke="currentColor" strokeWidth="0.8">
        ...
        {/* clear path — three camps linked into a route */}
        <circle cx="74" cy="82" r="7" strokeWidth="1.2" />
        <circle cx="126" cy="92" r="7" strokeWidth="1.2" />
        <circle cx="98" cy="128" r="7" strokeWidth="1.2" />
        <path d="M80 86 L120 90 M122 98 L104 122 M92 124 L80 90" strokeWidth="0.8" opacity=".55" strokeDasharray="3 3" />
